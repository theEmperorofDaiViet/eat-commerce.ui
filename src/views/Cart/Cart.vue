<template>
    <div class="container">
        ...
        <div class="col-md-5 px-3">
          <div class="card-block px-3">
            ...
            <p id="item-price" class="mb-0 font-weight-bold">
                {{ cartItem.product.price?.toLocaleString('vi', {style : 'currency', currency : 'VND'}) }}
            </p>
            ...
            <p id="item-total-price" class="mb-0">
              ...
              <span class="font-weight-bold">
                {{ (cartItem.product.price * cartItem.quantity)?.toLocaleString('vi', {style : 'currency', currency : 'VND'}) }}</span
              >
            </p>
      ...
      <div class="total-cost pt-2 text-right">
        <h5>Tổng cộng: {{ totalcost.toFixed(0)?.toLocaleString('vi', {style : 'currency', currency : 'VND'}) }}</h5>
        <button
          :disabled="isDisabled()"
          type="button"
